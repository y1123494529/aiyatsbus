...
object ActionMetadata {
    ...
    @KetherParser(["setMetadata", "set-metadata", "set-meta"])
    ...
    @KetherParser(["removeMetadata", "remove-metadata", "remove-meta"])
    ...
    @KetherParser(["hasMetadata", "has-metadata", "has-meta"])
    ...
    @KetherParser(["getMetadata", "get-metadata", "get-meta"])
